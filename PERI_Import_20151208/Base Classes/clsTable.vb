...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OWHS" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "OWTR" Or strTab = "OUSR" Or strTab = "OITW" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "INV1" Or strTab = "ORDR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            AddTables("Z_PERI_SERIES", "Peri Import Series", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            addField("@Z_PERI_SERIES", "Z_Series", "Series Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "M,A", "Manual, Automated", "M")
            '---- User Defined Object
            CreateUDO()
